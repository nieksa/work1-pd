...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.vit = ViT(image_size=32, image_patch_size=4, frames=32, frame_patch_size=4, num_classes=2, dim=1024,
                       depth=2, heads=16, mlp_dim=2048, pool = 'cls', channels = 64, dim_head = 64,
                       dropout = 0.1, emb_dropout = 0.1)
        # self.coordatt2 = CoordAtt3D(128, 128)
        # self.vit = ViT(image_size=16, image_patch_size=4, frames=16, frame_patch_size=4, num_classes=2, dim=128,
        #                depth=6, heads=8, mlp_dim=256, pool = 'cls', channels = 128, dim_head = 32,
        #                dropout = 0.1, emb_dropout = 0.1)
